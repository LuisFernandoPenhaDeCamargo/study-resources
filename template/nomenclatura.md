...
- A decisão de usar uma abreviação ou não, vai de acordo com a minha dificuldade em lembrar o significado dela
...
No Ubuntu, assim como na maioria dos SO baseados em Unix, não há um padrão estrito para a sintaxe de nomes de diretórios (ou para a sintaxe de nomes de arquivos), mas existem algumas convenções e boas práticas, recomendadas para evitar problemas e garantir a compatibilidade. Aqui estão algumas diretrizes importantes:
