...
7. [Ordem de Execução da Consulta SQL:](intermediario.md#ordem-de-execucao-da-consulta-sql)
    - Ordem Típica de Processamento
    - Impacto das Junções e Condições WHERE
    - Otimização de Consultas

8. [Subconsultas:](intermediario.md#subconsultas)
    - Subconsultas Escalares
    - Subconsultas Correlacionadas\
        - `EXISTS()`
    - Subconsultas na Cláusula FROM

9. [Filtros Avançados com `%` e LIKE:](intermediario.md#filtros-avancados-com--e-like)
    - O que é `%` e `LIKE`
    - Como Utilizar `%` e `LIKE`
    - Exemplo Prático
    - Considerações e Boas Práticas

10. [Funções de Data e Hora:](intermediario.md#funcoes-de-data-e-hora)
    - `FROM_UNIXTIME()`
    - `DATE_SUB()`

11. [ENUM no SQL:](intermediario.md#enum-no-sql)
    - O que é ENUM
    - Como Definir e Usar ENUM
    - Considerações e Boas práticas

12. [Cláusula `DELETE` no SQL: Exclusão de Registros e Tabelas](intermediario.md#clausula-delete-no-sql-exclusao-de-registros-e-tabelas)
...
14. [Transações e Controle de Concorrência:](avancado.md#ransacoes-e-controle-de-concorrencia)
    - O que é uma Transação
    - COMMIT, ROLLBACK, SAVEPOINT
    - Controle de Concorrência

15. [Stored Procedures e Funções:](avancado.md#stored-procedures-e-funcoes)
    - Criar e Executar Stored Procedures
    - Parâmetros de Entrada e Saída
    - Criar e Executar Funções

16. [Triggers:](avancado.md#triggers)
    - O que são Triggers
    - Quando Usar Triggers
    - Exemplos Práticos

17. [Segurança:](avancado.md#seguranca)
    - GRANT e REVOKE
    - Níveis de Permissão
    - Melhores Práticas de Segurança em SQL

18. [Backup e Recuperação:](avancado.md#backup-e-recuperacao)
    - Estratégias de Backup
    - RESTORE e RECOVERY

19. [Noções de Modelagem de Dados:](avancado.md#nocoes-de-modelagem-de-dados)
    - Normalização
    - Relacionamentos entre Tabelas

### Prática:

20. [Projetos Práticos:](pratica.md#projetos-praticos)
    - Criar um Banco de Dados Realista
    - Implementar Consultas Complexas
    - Otimizar Consultas e Índices

21. [Ferramentas e Ambientes:](pratica.md#ferramentas-e-ambientes)
    - Uso de Ferramentas como MySQL Workbench, pgAdmin, etc.
    - Ambientes de Desenvolvimento e Produção

22. [Integração com Linguagens de Programação:](pratica.md#integracao-com-linguagens-de-programacao)
