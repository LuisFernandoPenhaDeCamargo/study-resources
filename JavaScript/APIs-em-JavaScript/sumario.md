...
1. [Introdução ao JavaScript e Node.js](nivel-inicial.md#introducao-ao-javascript-e-nodejs)
2. [Configuração do ambiente de desenvolvimento](nivel-inicial.md#configuracao-do-ambiente-de-desenvolvimento)
3. [Manipulação de módulos e pacotes com o npm](nivel-inicial.md#manipulacao-de-modulos-e-pacotes-com-o-npm)
4. [Noções básicas de APIs e solicitações HTTP](nivel-inicial.md#nocoes-basicas-de-apis-e-solicitacoes-http)

### Nível Intermediário: Trabalhando com APIs

5. [Conceitos de RESTful APIs](nivel-intermediario.md#conceitos-de-restful-apis)
6. [Uso do módulo `axios` para fazer solicitações HTTP](nivel-intermediario.md#uso-do-modulo-axios-para-fazer-solicitacoes-http)
7. [Tratamento de respostas JSON](nivel-intermediario.md#tratamento-de-respostas-json)
